...
namespace bot.Clases.Logica.Loop
{
    class SellControl
    {
        ...
        public static void SellManager(uint id)
        {
            ...
            {
                if (true)// (Globals.MainWindow.Checked(Globals.MainWindow.nopick) == true)
                {
                    Data.loopaction = "weapon";
                    BuyControl.BuyManager(Spawns.NPCID[Spawns.NPCType.IndexOf(Data.selectednpctype)]);
                }
                else if (true)// (Globals.MainWindow.Checked(Globals.MainWindow.normalpick) == true)
                {
                    for (byte slot = 13; slot < Caracter.InventorySize; slot++)
                    {
                        ...
                        if (index != -1)
                        {
                            ...
                            if (type != null && type.Contains("RARE") == false && type.Contains("ITEM_MALL") == false)
                            {
                                ...
                                {
                                    if (true) //(Globals.MainWindow.ReadText(Globals.MainWindow.wep_drop) == "Sell" && type != Data.f_wep_name && type != Data.s_wep_name)
                                    {
                                ...
                                {
                                    if (true)// (Globals.MainWindow.ReadText(Globals.MainWindow.armor_drop) == "Sell")
                                    {
                                        Send(slot, Data.inventorycount[index], id);
                                        break;
                                    }
                                ...
                                {
                                    if (true)// (Globals.MainWindow.ReadText(Globals.MainWindow.acc_drop) == "Sell")
                                    {
                                        Send(slot, Data.inventorycount[index], id);
                                        break;
                                    }
                                ...
                                {
                                    if (true)// (Globals.MainWindow.ReadText(Globals.MainWindow.wepe_drop) == "Sell")
                                    {
                                        Send(slot, Data.inventorycount[index], id);
                                        break;
                                    }
                                ...
                                {
                                    if (true)// (Globals.MainWindow.ReadText(Globals.MainWindow.shielde_drop) == "Sell")
                                    {
                                        Send(slot, Data.inventorycount[index], id);
                                        break;
                                    }
                                ...
                                {
                                    if (true)// (Globals.MainWindow.ReadText(Globals.MainWindow.prote_drop) == "Sell")
                                    {
                                        Send(slot, Data.inventorycount[index], id);
                                        break;
                                    }
                                ...
                                {
                                    if (true)// (Globals.MainWindow.ReadText(Globals.MainWindow.acce_drop) == "Sell")
                                    {
                                        Send(slot, Data.inventorycount[index], id);
                                        break;
                                    }
                                ...
                                {
                                    if (true)// (Globals.MainWindow.ReadText(Globals.MainWindow.tablets_drop) == "Sell")
                                    {
                                        Send(slot, Data.inventorycount[index], id);
                                        break;
                                    }
                                ...
                                {
                                    if (true)// if (Globals.MainWindow.ReadText(Globals.MainWindow.materials_drop) == "Sell")
                                    {
                                        Send(slot, Data.inventorycount[index], id);
                                        break;
                                    }
                        ...
                        if (slot + 1 >= Caracter.InventorySize)
                        {
                            Data.loopaction = "weapon";
                            BuyControl.BuyManager(Spawns.NPCID[Spawns.NPCType.IndexOf(Data.selectednpctype)]);
                            break;
        ...
        {
            Packet NewPacket = new Packet(Opcode.CLIENT_INVENTORY_ITEM_MOVEMENT);
