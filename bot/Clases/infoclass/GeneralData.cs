...
namespace bot.Clases.infoclass
{
    ...
    class Items_Info
    {
        ...
        public static List<string> items_iconlist = new List<string>();
    }
    class Item_RealName
    {
        public static List<string> referenceNames1 = new List<string>();
        public static List<string> realNames1 = new List<string>();
        public static List<string> referenceNames2 = new List<string>();
        public static List<string> realNames2 = new List<string>();
    }
    class Data
    {
        ...
        public static Dictionary<byte, DataItemInventory> inventory = [];
        public static Dictionary<string, ItemData> Itemdatatext = [];
        public static List<byte> inventoryslot = [];
        public static List<uint> inventoryid = [];
        public static List<string> inventorytype = [];
        public static List<ushort> inventorycount = [];
        public static List<uint> inventorydurability = [];
        public static List<byte> inventorylevel = [];
        public static List<string> inventoryname = [];
        public static List<string> inventoryicon = [];
        public static List<uint> maxdurability = [];
