...
var helper = require('../utils/bitwise');
...
$Security.resetHandshakeState = Security$resetHandshakeState;
...
/**
 * Resetea el estado del handshake para una nueva conexión (ej: al cambiar de Gateway a Agent).
 * El Blowfish se reinicializará durante el nuevo handshake.
 */
function Security$resetHandshakeState() {
    this.m_started_handshake = false;
    this.m_accepted_handshake = false;
    this.m_security_flag = 0;
    this.m_security_flags = {
    ...
    this.m_client_security = false;
    // Reinicializar Blowfish fresco
    this.m_blowfish = new (require('./blowfish/Blowfish'))();
}
