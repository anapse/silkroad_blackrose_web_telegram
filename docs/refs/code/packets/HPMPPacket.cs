        ...
        {
            {
                ...
                if (id == Caracter.UniqueID)
                {
                    ...
                    {
                        case 0x01:
                            Caracter.CurrentHP = hp_packet.ReadUInt32();
                            break;
                        case 0x02:
                            Caracter.CurrentMP = hp_packet.ReadUInt32();
                            break;
                        case 0x03:
                            Caracter.CurrentHP = hp_packet.ReadUInt32();
                            Caracter.CurrentMP = hp_packet.ReadUInt32();
                  ...
                  /*  if (Caracter.CurrentMP >= Buffas.min_mp_require)
                    {
                        Buffas.min_mp_require = 200000;
                        Buffas.buff_waiting = true;
                    }*/
                    if (Caracter.CurrentHP > 0)
                    {
                        Data.dead = false;
                    }
                    else
                    ...
                    uint hp = Caracter.CurrentHP * 100 / Caracter.MaxHP;
                    uint mp = Caracter.CurrentMP * 100 / Caracter.MaxMP;
